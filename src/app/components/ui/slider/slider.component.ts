...
import { Component, model, computed, signal, ViewChild, ElementRef, HostListener } from "@angular/core";
...
export class SliderComponent {
  ...
  private updateSliderValue(event: MouseEvent): void {
    ...
    offsetX = Math.max(0, Math.min(offsetX - (thumbHandleWidth / 2), sliderWidth));
