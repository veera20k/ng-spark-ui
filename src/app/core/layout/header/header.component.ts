  ...
  >
    <div class="flex items-center justify-between py-2 lg:px-12 px-6">
      <div class="flex items-center">
        <spark-sheet>
          <span role="button" class="mx-4 font-medium text-lg inline lg:hidden" slot="trigger">
            ☰
          </span>
      ...
      <div class="flex gap-2 text-sm">
        ...
        <span
          ><a href="https://github.com/veera20k/ng-spark-ui" target="_blank"
            >Github</a
          ></span
        >
        <svg
        ...
        <span
          ><a href="https://x.com/ngsparkdev" target="_blank">Twitter</a></span
        >
      </div>
    </div>
  </div>`,
